...
public class MantGastosCaja extends BaseJFrame implements ParentFrameMethodListener {

    Empleado usuLogueado;
    Movimiento objetoTemp;

    public MantGastosCaja() {
        initComponents();
    }
    ...
    public void ModoDefault(boolean ejecutarModoDefaultListado) throws Exception {
        ...
        if (ejecutarModoDefaultListado) {
            panelListadoGastos1.ModoDefault();
        }
    }
    // </editor-fold>
    ...
    private void Alta() throws Exception {
        ...
        if (IsNotABigDecimal(monto)) {
            throw new Exception(Constantes.gastos_MontoErrorFormato);
        }
        ...
        objetoTemp.setTipoMov(Enumeraciones.TipoMov.Gasto);
        ...
        switch (resultado) {
            case 0:
                //Caso exitoso
                ModoDefault(true);
                lblError.setText(Constantes.gasto_ExitoAlta);
                break;
            case -2:
                lblError.setText(Constantes.gasto_ErrorAlta_m2);
            case -1:
            default:
                lblError.setText(Constantes.gasto_ErrorAlta_m1);
                break;
        }
    }
    ...
    public void Eliminar(int idMov) throws Exception {
        ...
        switch (resultado) {
            case 0:
                //Caso exitoso
                ModoDefault(true);
                lblError.setText(Constantes.gasto_ExitoBaja);
                break;
            case -1:
            default:
                lblError.setText(Constantes.gasto_ErrorBaja_m1);
                break;
        }
    }
    ...
    private void Modificar() throws Exception {
        ...
        switch (resultado) {
            case 0:
                //Caso exitoso
                ModoDefault(true);
                lblError.setText(Constantes.gasto_ExitoModif);
                break;
            case -2:
                lblError.setText(Constantes.gasto_ErrorModif_m2);
            case -1:
            default:
                lblError.setText(Constantes.gasto_ErrorModif_m1);
                break;
        }
    }
    ...
    public void ProcesarPrimerCargado(Empleado _usuLogueado) throws Exception {
        ...
        panelListadoGastos1.setSucActual(usuLogueado.getSucursal().getIdSuc());
        panelListadoGastos1.ProcesarPrimerCargado(TipoMov.Gasto);
        panelListadoGastos1.Listar(null);
        panelListadoGastos1.addParentFrameMethodListener(this);
    }
    // </editor-fold>
    ...
    private void initComponents() {
        ...
        panelListadoGastos1 = new Presentacion.Controls.PanelListadoMovs();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Mantenimiento De Gastos");
        setMinimumSize(new java.awt.Dimension(960, 575));

        lblTitulo3.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lblTitulo3.setText("GASTOS:");
        ...
        jPanelContenido.setMinimumSize(new java.awt.Dimension(918, 517));
        jPanelContenido.setName(""); // NOI18N
        jPanelContenido.setPreferredSize(new java.awt.Dimension(960, 552));
        ...
        lblTitulo1.setText("Mant. de gastos generados:");
        ...
        jPanelContenidoLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelContenidoLayout.createSequentialGroup()
                ...
                .addComponent(panelListadoGastos1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        jPanelContenidoLayout.setVerticalGroup(
            ...
            .addGroup(jPanelContenidoLayout.createSequentialGroup()
                ...
                .addGroup(jPanelContenidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanelMant, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(panelListadoGastos1, javax.swing.GroupLayout.DEFAULT_SIZE, 541, Short.MAX_VALUE)))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanelContenido, javax.swing.GroupLayout.PREFERRED_SIZE, 901, Short.MAX_VALUE)
        );
    ...
    private Presentacion.Controls.PanelListadoMovs panelListadoGastos1;
