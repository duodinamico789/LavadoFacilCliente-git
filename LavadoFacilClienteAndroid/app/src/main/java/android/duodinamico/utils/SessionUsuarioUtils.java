...
//        editor.putString(KEY_FECHA_OLVIDO_PASS, df.format(c.getfechaOlvidoPass()));
//        editor.putString(KEY_FECHA_REG, df.format(c.getfechareg()));
//        editor.putString(KEY_FECHA_ULTIMA_ENTRADA, df.format(c.getfechaUltimaEntrada()));
    ...
    public Cliente getDetailsCliente() throws ParseException {
        ...
        Cliente c = new Cliente(pref.getString(KEY_CEDULA,null),
